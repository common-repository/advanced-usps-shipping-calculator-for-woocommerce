 ...
 * WC_USPS_ADV_Shipping_AuctionInc class.
...
class WC_USPS_ADV_Shipping_AuctionInc extends WC_Shipping_Method {
    ...
    public function __construct() {
        ...
        $this->method_title = __('USPS Advanced', 'wc_auctioninc');

        $this->method_description = __('<strong>AuctionInc\'s USPS Advanced</strong> extension obtains USPS shipping rates dynamically from the AuctionInc API during cart/checkout.', 'wc_auctioninc');
    ...
    public function calculate_shipping( $package=array() ) {
        ...
        if ($this->account_id) {
            ...
            if (!empty($package['destination']['country'])) {
                ...
                $shipAPI->setHeaderRefCode('woo-usps-adv');
                ...
                if (!empty($shipRates['ShipRate'])) {
                    ...
                    if (!empty($this->fallback_type) && !empty($this->fallback_fee) && $use_fallback == true) {
                        ...
                        // WooCommerce handles errors for us
